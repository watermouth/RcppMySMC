...
SEXP pfPoissonEdge1DSelfOrgUsingOneStep(NumericVector observations, int numOfParticles, double sigma_alpha, double alpha0, double beta0, double lambda0, double lambdaMax);
...
static bool validateExported(const std::string& sig) {
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("SEXP(*pfPoissonEdge1DSelfOrgUsingOneStep)(NumericVector,int,double,double,double,double,double)");
...
RCPP_MODULE(RcppMySMC_RcppExports) {
    ...
    Rcpp::function("pfPoissonEdge1DSelfOrgUsingOneStep", &pfPoissonEdge1DSelfOrgUsingOneStep, Rcpp::List::create(Rcpp::Named("observations"), Rcpp::Named("numOfParticles"), Rcpp::Named("sigma_alpha"), Rcpp::Named("alpha0"), Rcpp::Named("beta0"), Rcpp::Named("lambda0"), Rcpp::Named("lambdaMax")));
